...
class UserControllerTest extends Zend_Test_PHPUnit_ControllerTestCase
{
    ...
    {
        $params = array('action' => 'listUsers', 'controller' => 'User', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'delete', 'controller' => 'User', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
    ...
    {
        $params = array('action' => 'block', 'controller' => 'User', 'module' => 'default');
        $urlParams = $this->urlizeOptions($params);
        $url = $this->url($urlParams);
        $this->dispatch($url);
